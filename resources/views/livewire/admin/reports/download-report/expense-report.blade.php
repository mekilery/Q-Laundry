                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <p class="text-xs  font-weight-bold mb-0">
                            {{ getCurrency() }}{{ number_format($row->expense_amount, 3) }}</p>
                    </td>
                    <td style="text-align: center">
    ...
    <table cellspacing="15">
        <tr>
            ...
            <td class="col"> <span class="text-sm mb-0 fw-500">{{$lang->data['total_expense_amount'] ?? 'Total Expense Amount'}}:</span>
                <span
                    class="text-sm text-dark ms-2 fw-600 mb-0">{{ getCurrency() }}{{ number_format($expenses->sum('expense_amount'), 3) }}</span>
            </td>
            <td class="col">
                <span class="text-sm mb-0 fw-500">{{$lang->data['total_tax_amount'] ?? 'Total Tax Amount'}}:</span>
                <span
                    class="text-sm text-dark ms-2 fw-600 mb-0">{{ getCurrency() }}{{ number_format($tax_amount_total, 3) }}</span>
            </td>
        </tr>
    </table>
</body>
