<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('admin.pos') }}">
            <img src="{{ asset(getSiteLogo()) }}" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 h5 font-weight-bold text-uppercase">{{ getApplicationName() }}
            </span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('admin/order-status*') ? 'active' : '' }}"
                    href="{{ route('admin.status_screen_order') }}">
                    <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-warning text-sm opacity-10"></i>
                    </div>
                    <span
                        class="nav-link-text ms-1">{{ $lang->data['order_status_screen'] ?? 'Order Status Screen' }}</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            @if (Auth::user()->user_type == 1)
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#expense"
                        class="nav-link {{ Request::is('admin/expense*') ? 'active' : '' }}" aria-controls="settings"
                            ...
                            <li class="nav-item ">
                                <a class="nav-link  {{ Request::is('admin/expense') ? 'active' : '' }} "
                                    ...
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['expense_list'] ?? 'Expense List' }}</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('admin/expense/categories') ? 'active' : '' }}"
                                    href="{{ route('admin.expense_categories') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> E </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['expense_category'] ?? 'Expense Category' }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#services"
                        class="nav-link  {{ Request::is('admin/service*') ? 'active' : '' }}" aria-controls="settings"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                        ...
                        <ul class="nav ms-4">
                            <li class="nav-item {{ Request::is('admin/service') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.service_list') }}">
                                    ...
                                    <span
                                        class="sidenav-normal side-bar-inner">{{ $lang->data['service_list'] ?? 'Service List' }}</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::is('admin/service/type') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.service_type') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> S </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['service_type'] ?? 'Service Type' }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('admin/service/addons') ? 'active' : '' }}"
                                    href="{{ route('admin.service_addons') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> A </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['addons'] ?? 'Addons' }} </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#tasks"
                        class="nav-link {{ Request::is('admin/reports*') ? 'active' : '' }}" aria-controls="tasks"
                        role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="collapse {{ Request::is('admin/reports*') ? 'show' : '' }}" id="tasks">
                        <ul class="nav ms-4">
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('admin/reports/daily') ? 'active' : '' }}"
                                    href="{{ route('admin.daily_report') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> D </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['daily_report'] ?? 'Daily Report' }} </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('admin/reports/order') ? 'active' : '' }}"
                                    ...
                                    <span class="sidenav-mini-icon side-bar-inner"> O </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['order_report'] ?? 'Order Report' }} </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('admin/reports/sales') ? 'active' : '' }}"
                                    ...
                                    <span class="sidenav-mini-icon side-bar-inner"> S </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['sales_report'] ?? 'Sales Report' }}</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('admin/reports/expense') ? 'active' : '' }}"
                                    href="{{ route('admin.expense_report') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> E </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['expense_report'] ?? 'Expense Report' }} </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('admin/reports/tax') ? 'active' : '' }}"
                                    href="{{ route('admin.tax_report') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> T </span>
                                    <span
                                        class="sidenav-normal side-bar-inner">{{ $lang->data['tax_report'] ?? 'Tax Report' }}
                                    </span>
                                </a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ Request::is('admin/settings*') ? 'show' : '' }}" id="settings">
                        <ul class="nav ms-4">
                            <li class="nav-item ">
                                <a class="nav-link  {{ Request::is('admin/settings/financial-year') ? 'active' : '' }}"
                                    href="{{ route('admin.financial_year_settings') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> F </span>
                                    <span
                                        class="sidenav-normal side-bar-inner">{{ $lang->data['financial_year'] ?? 'Financial Year' }}
                                    </span>
                                </a>
                            </li>
                            <li class="nav-item "> <a
                                    class="nav-link {{ Request::is('admin/settings/payment-types') ? 'active' : '' }}"
                                    href="{{ route('admin.payment_types_settings') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> P </span>
                                    <span
                                        class="sidenav-normal side-bar-inner">{{ $lang->data['payment_types'] ?? 'Payment Types' }}
                                    </span> </a> </li>
                            <li class="nav-item ">
                                <a class="nav-link  {{ Request::is('admin/settings/translations') ? 'active' : '' }}"
                                    href="{{ route('admin.translations') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> T </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['translations'] ?? 'Translations' }} </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link  {{ Request::is('admin/settings/mail') ? 'active' : '' }}"
                                    href="{{ route('admin.mail_settings') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> T </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['mail_settings'] ?? 'Mail Settings' }} </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link  {{ Request::is('admin/settings/master') ? 'active' : '' }}"
                                    href="{{ route('admin.master_settings') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> M </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['master_settings'] ?? 'Master Settings' }} </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link  {{ Request::is('admin/settings/file-tools') ? 'active' : '' }}"
                                    href="{{ route('admin.filetools') }}">
                                    <span class="sidenav-mini-icon side-bar-inner"> F </span>
                                    <span class="sidenav-normal side-bar-inner">
                                        {{ $lang->data['file_tools'] ?? 'File Tools' }} </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link  {{ Request::is('admin/settings/sms') ? 'active' : '' }}"
                                    ...
                                    <span class="sidenav-mini-icon side-bar-inner"> S </span>
                                    <span
                                        class="sidenav-normal side-bar-inner">{{ $lang->data['sms_settings'] ?? 'SMS Settings' }}
                                    </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link  {{ Request::is('admin/settings/staff') ? 'active' : '' }}"
                                    ...
                                    <span class="sidenav-mini-icon side-bar-inner"> S </span>
                                    <span class="sidenav-normal side-bar-inner">{{ $lang->data['staff'] ?? 'Staff' }}
                                    </span>
                                </a>
                            </li>
                        </ul>
