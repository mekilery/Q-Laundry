...
class Expenses extends Component
{
    ...
    public function store()
    {
        ...
        if ($this->tax_included == 1) {
            ...
            $expense->tax_percentage = $this->tax_percentage ?? 0.0;
        }
        ...
        $expense->payment_type = $this->payment_type;
    ...
    public function updated($name, $value)
    {
        ...
        if ($name == 'search' && $value != '') {
            ...
            if (Auth::user()->user_type == 1) {
                ...
                $this->expenses = Expense::where('created_by', Auth::user()->id)
    ...
    public function edit($id)
    {
        ...
        $this->payment_type = $this->expense->payment_type ? $this->expense->payment_type : 0;
